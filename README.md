...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   ...
   Placing things in a certain place for a specific purpose.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
    
    With inline height and width have no changes. Block, starts on a seperate line and take up all the width.
...
5. Explain why git is valuable to a team of developers.
   ...
   Git allows you to stay organized and allows you to access previous versions keeping projects organized.
